...
class AddItems extends Component {
    ...
    handleAddData = (event) => {
        ...
        if ((inputs.dateOfProdYear == "") || (inputs.dateOfProdMonth == "")) {
            this.setState(prevState => ({
                messages: {...prevState.messages, error: "Please fill all input fileds..."}
            }));
            return false;
        } 
    ...
    render() { 
        ...
        return ( 
            ...
            >      
                ...
                <span>/</span>
                <select id={this.state.ids.idMonth} value={this.state.addInputs.dateOfProdMonth}
                onChange={(e) => this.handleAddInputs(e.target.value, e.target.id)}
                >
                    <option></option>  
                ...
                <label>Brand and car:</label><br></br>
                <input id={this.state.ids.idBrand} className="input-car" type="text" 
                required placeholder="brand..." value={this.state.addInputs.brand}
                onChange={(e) => this.handleAddInputs(e.target.value, e.target.id)}
                >
                </input>
                <input id={this.state.ids.idCar} className="input-car" type="text" 
